...
public class BiQuGePageProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        logger.info("爬取地址：" + page.getUrl().regex(siteUrl + "\\w+/\\w+.html").toString());
    ...
    public void getArticle(Page page) {
        ...
        //设置章节目录
        article.setUrl(page.getUrl().regex(spiderUrl+"/\\w+/(\\w+)").toString());
        //设置小说目录
    ...
    public void getBook(Page page) {
        ...
        book.setChapterPage(page.getHtml().xpath("//*[@id=\"list\"]/dl")
                ...
                .replace(siteUrl, "")
                .get());
        logger.error("book.getChapterPage():"+book.getChapterPage());
