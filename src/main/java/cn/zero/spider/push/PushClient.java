 ...
 *
*/
package cn.zero.spider.push;

import cn.zero.spider.push.utils.*;
...
public class PushClient {
	 ...
	 * @throws ApiException
	 */
	public String createPushDefaultNotify(String workno,String title, String content) throws ApiException{
		String[] strings =new String[1];
		strings[0] = content;
		PushWork work = new PushWork(MobPushConfig.appkey, workno, PlatEnum.all.getCode(), content, PushTypeEnum.notify.getCode()).buildTarget(TargetEnum._1.getCode(), null, null, null, null, null)
				.buildAndroid(title,0,strings,true,true,true);
		return this.sendPush(work);
	}
